...
contract RPS{
    ...
    function withdraw() public {
        ...
        if (numPlayer == 1) { // 3. เงินของ plyer 0 อาจถูกล็อกหากไม่มี player 1 มาลงขัน
            idx = 0;
        
        } else { // 4. กรณี ได้ 2 player แต่มีแค่ player เดียวที่ลงขัน ทำให้เงินถูกล้อก 
    ...
    function _restartGame() private  {
        ...
        reward = 0;
        numInput = 0;
        address account0 = player[0].address;
        address account1 = player[1].address;
